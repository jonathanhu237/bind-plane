...
## Purpose
Define startup bootstrap behavior for Bind Plane, including first-admin initialization, configuration requirements, process boundaries, and credential handling.
## Requirements
